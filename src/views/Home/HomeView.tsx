      ...
      <main className="mb-auto h-screen overflow-auto">
        <section className="relative h-full bg-primary grid grid-cols-2">
              ...
              <div className="h-button-started w-button-started">
                {!active && (
                    <>
                      ...
                      <div
                          className=" bg-transparent focus:outline-none h-button-started w-button-started border border-white rounded-full transform translate-x-3 translate-y-3"/>
                    </>
                )}
              </div>
            </div>
          ...
          <motion.div
              ...
              initial={{scale: 1, opacity: 1, rotate: 45, translateY: 80, translateX: -480}}
          ...
          />
          <div
              className="z-10 absolute transform translate-y-20 translate-x-100 rotate-45 h-divbg w-divbg bg-secondary ring-1 ring-white ring-offset-18 ring-offset-primary"></div>
        </section>
        <section className="relative h-full bg-primary overflow-hidden ">
          ...
          <div className="grid grid-cols-2 h-full">
            ...
            <motion.div
                ...
                initial={{scale: 1, opacity: 1, rotate: -60, translateY: 10, translateX: -300}}
                animate={{scale: 1.1, opacity: 0}}
                transition={{
                  duration: 4,
                  type: "spring",
            ...
            />
            <div
                className="z-20 absolute transform translate-y-0 translate-x-90 rotate-60 h-divbg2 w-divbg bg-ternary ring-1 ring-ternary ring-offset-18 ring-offset-primary"></div>
          </div>
        </section>
      </main>
  );
