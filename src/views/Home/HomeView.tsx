  ...
  return (
    <main className="mb-auto h-screen w-screen overflow-auto">
      <div className="overflow-hidden w-full">
        ...
        <section
          ref={sectionRef}
          className={`${windowWidth > 700 ? 'content-landing' : ''} relative bg-primary grid md:grid-cols-2 sm:grid-cols-1 overflow-hidden`}
        >
          ...
          <div className={`${windowWidth < 700 ? 'w-screen' : ''} z-40 flex justify-center items-center`}>
