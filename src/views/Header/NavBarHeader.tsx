  ...
  return (
      <>
        <nav className="z-20 flex items-center justify-between flex-wrap bg-teal p-3 bg-primary">
          <Link to="/" className="flex items-center flex-no-shrink text-primary mr-6">
          ...
          <div className="h-7 w-40 mr-6">
            {active ? (
                <>
                  ...
                  <div
                      className=" bg-transparent focus:outline-none h-7 w-40 border border-ternary rounded-full transform translate-x-1 translate-y-1"/>
                </>
            ) : (<>
              <button
                  type="button"
